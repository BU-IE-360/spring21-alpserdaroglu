...
The above graph displays the time series for the CPI of Clothes and Shoes is plotted. The data shows an increasing trend combined with a yearly seasonality. Price levels are affected considerably by the month of the year.
```{r}
