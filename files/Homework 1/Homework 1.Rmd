...
ggplot(credit_table, aes(y = NewCredit, x = as.factor(year(Tarih))))+
  geom_boxplot()+
  labs(title = "Distribution of Consumer Loans Based on the Year", x = "Year", y = "Consumer Loans")
```
...
```{r Interest Rates 2, warning=FALSE}
...
The data for the search volumes are collected using Google Trends. Data collected for the years 2016 through 2019. Frequency of observations is once per week.
```{r Part II, echo=FALSE, message=FALSE, warning=FALSE}
#PART II
setwd("C:/Users/alpsr/Desktop/Data") # Please change your working directory after downloading the data from Google Trends
